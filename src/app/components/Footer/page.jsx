...
export default function Footer() {
  return (
    <footer className="relative mt-20 text-white">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e]"></div>
      ...
      >
        {/* Logo / About */}
        <div>
          <h2 className="text-3xl font-extrabold text-pink-500 tracking-wide">Mubashir Shopify</h2>
      ...
      {/* Bottom */}
      <div className="relative border-t border-gray-700 text-center py-6 text-gray-400 text-sm z-10 mt-6">
