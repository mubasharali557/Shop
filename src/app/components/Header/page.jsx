...
//             {/* ✅ Deliver to with Truck Icon */}
//             <Link
//               href="/deliverto"
//               className="hover:text-pink-500 hidden sm:flex items-center gap-1"
//             >
...
//                  <Link
//   href="/addtocart"
//   className="block w-full text-center bg-green-600 text-white py-2 rounded-lg hover:bg-green-700 mt-3 transition"
// >
//   ✅ Checkout
// </Link>
//                 </div>
...
//         <Link href="/beverages" className="hover:text-pink-500">
//           Beverages
//         </Link>
//         <Link href="/Milk" className="hover:text-pink-500">
//           Milk
//         </Link>
//         <Link href="/HandAndBodyWashes" className="hover:text-pink-500">
//           Hand And Body Washes
//         </Link>
//         <Link href="/toothBrushesPastes" className="hover:text-pink-500">
//           Tooth Brushes (Pastes)
//         </Link>
//         <Link href="/homeProducts" className="hover:text-pink-500">
//           Similar Products
//         </Link>
//         <Link href="/CookingOIL" className="hover:text-pink-500">
//           Cooking OIL
//         </Link>
//         <Link href="/skincare" className="hover:text-pink-500">
//           Skin Care
//         </Link>
//         <Link href="/housecleaning" className="hover:text-pink-500">
//           House Cleaning
//         </Link>
//         <Link href="/juices" className="hover:text-pink-500">
//           Juices
//         </Link>
//       </nav>
//     </div>
...
"use client";
import Link from "next/link";
import { FiSearch, FiTruck, FiMenu, FiX } from "react-icons/fi"; 
import Image from "next/image";
import React, { useEffect, useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useCart } from "@/app/context/CartContext";
        ...
        <AnimatePresence>
          {menuOpen && (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
              className="md:hidden bg-white border-t mt-2 rounded-lg shadow-lg overflow-hidden"
            >
              <div className="flex flex-col space-y-4 px-4 py-4 text-sm font-semibold">
                <Link href="/about" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  About My Shop
                </Link>
                <Link href="/deliverto" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Deliver to
                </Link>
                <Link href="/beverages" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Beverages
                </Link>
                <Link href="/Milk" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Milk
                </Link>
                <Link href="/HandAndBodyWashes" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Hand And Body Washes
                </Link>
                <Link href="/toothBrushesPastes" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Tooth Brushes (Pastes)
                </Link>
                <Link href="/homeProducts" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Similar Products
                </Link>
                <Link href="/CookingOIL" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Cooking OIL
                </Link>
                <Link href="/skincare" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Skin Care
                </Link>
                <Link href="/housecleaning" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  House Cleaning
                </Link>
                <Link href="/juices" onClick={() => setMenuOpen(false)} className="hover:text-pink-500">
                  Juices
                </Link>
              </div>
            </motion.div>
